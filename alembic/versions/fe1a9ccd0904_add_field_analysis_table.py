"""add field_analysis table

Revision ID: fe1a9ccd0904
Revises: 21a3a4f6ffb0
Create Date: 2026-02-21 16:03:09.010053
...
revision: str = 'fe1a9ccd0904'
down_revision: Union[str, Sequence[str], None] = '21a3a4f6ffb0'
...
def upgrade() -> None:
    ...
    op.create_table('field_analysis',
    ...
    op.create_index(op.f('ix_field_analysis_id'), 'field_analysis', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_field_analysis_id'), table_name='field_analysis')
    op.drop_table('field_analysis')
    # ### end Alembic commands ###
